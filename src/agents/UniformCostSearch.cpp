...
/* *********************************************************************
   ...
   ******************************************************************* */
UniformCostSearch::UniformCostSearch(RomSettings *rom_settings, Settings &settings,
...
void UniformCostSearch::print_path(TreeNode * node, int a) {
...
void UniformCostSearch::clear()
{
	SearchTree::clear();
}

void UniformCostSearch::move_to_best_sub_branch() 
{
...
/* *********************************************************************
   ...
   ******************************************************************* */
void UniformCostSearch::update_branch_return(TreeNode* node) {
...
void UniformCostSearch::set_terminal_root(TreeNode * node) {
	node->branch_return = node->node_reward; 
