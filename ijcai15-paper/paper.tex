...
\Omit{Namely}
\nir{While the \emph{reinforcement learning} problem seeks to synthesize a controller as a policy/function that maximizes 
the reward of any trajectory}, we seek  an action sequence $a_0, a_1, \ldots, a_m$ from the  current  state $s_0$ that generates
