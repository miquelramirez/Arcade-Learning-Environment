...
action each $5$ frames, its performance is reduced by up to a $50$\% in
games where it performs very well (\CrazyClimber), and does not a difference in those games where it does very poorly (\Freeway). We'll look at this further in the future.
