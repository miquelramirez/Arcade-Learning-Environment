...
\newcommand{\CrazyClimber}{\propername{Crazy\_climber}}
...
\newcommand{\Montezuma}{\propername{Montezuma\_revenge}}
\newcommand{\StarGunner}{\propername{Star\_gunner}}
...
The  empirical results suggest that the performance of \IW\ with the  $k$ parameter fixed to $1$, 
i.e., $\IW(1)$, approaches the performance of the state of the art represented by 
 \UCT, and that a simple best-first variation  of \IW\  that combines exploration 
and exploitation is even more competitive.
...
part of  Table~\ref{table1}. Moreover, \IW\ is  faster and results in shorter plans than a heuristic search algotrithm
\cite{nir:ecai2012}.
...
\propername{Assault} & 806.4 & 18.21 & 852.6 & 25.11 & 413.7 & \textbf{1512.2} \\ \hline
\propername{Asterix} & 153400 & 24.33 & 77200 & 26.58 & 2135.7 & \textbf{290700} \\ \hline
\propername{Asteroids} & \mc{1}{\textbf{51338}} & 65.92 & \mc{1}{22168} & 64.53 & 3127.4 & 4660.6 \\ \hline
\propername{Atlantis} & 159420 & 12.8 & \multicolumn{1}{l}{--} & \multicolumn{1}{l|}{--} & 30460 & \textbf{193858} \\ \hline
\propername{Bank\_heist} & \mc{1}{\textbf{717}} & 39.29 & 362 & 63.83 & 21.5 & 497.8 \\ \hline
\propername{Battle\_zone} & 11600 & 85.96 & \multicolumn{1}{l}{--} & \multicolumn{1}{l|}{--} & 6312.5 & \textbf{70333.3} \\ \hline
\propername{Beam\_rider} & \mc{1}{9108} & 22.53 & \mc{1}{\textbf{9297.6}} & 29.03 & 693.5 & 6624.6 \\ \hline
\propername{Berzerk} & \mc{1}{\textbf{2096}} & 58 & \mc{1}{802} & 73.47 & 195 & 553.5 \\ \hline
\propername{Bowling} & \mc{1}{\textbf{68.6}} & 9.84 & \mc{1}{50.4} & 59.52 & 25.5 & 25.1 \\ \hline
\propername{Boxing} & 100 & 15.2 & 100 & 22.3 & 100 & 100 \\ \hline
\propername{Breakout} &\mc{1}{384.2} & 4.22 & \mc{1}{\textbf{771.6}} & 39.47 & 1.1 & 364.4 \\ \hline
\propername{Centipede} & 99207.2 & 39.14 & 93067 & 65.49 & \textbf{125123} & 110422 \\ \hline
\propername{Chopper\_command} & 2100 & 41.06 & 3800 & 40.94 & 1827.3 & \textbf{34018.8} \\ \hline
\propername{Crazy\_climber} & 36160 & 3.61 & 36940 & 58.12 & 37110 & \textbf{98172.2} \\ \hline
\propername{Enduro} & \mc{1}{\textbf{500}} & 65.69 & \mc{1}{359.4} & 37.66 & 0.6 & 286.3 \\ \hline
\propername{Freeway} & \mc{1}{\textbf{30.6}} & 31.69 & \mc{1}{22.6} & 60.77 & 0 & 0.4 \\ \hline
\propername{Frostbite} & \mc{1}{\textbf{3582}} & 12.25 & \multicolumn{1}{l}{--} & \multicolumn{1}{l|}{--} & 137.2 & 270.5 \\ \hline
\propername{Gravitar} & \mc{1}{3920} & 61.85 & \mc{1}{\textbf{5980}} & 62.45 & 395 & 2850 \\ \hline
\propername{Hero} & \mc{1}{\textbf{12887}} & 36.63 & 7096.6 & 51.83 & 1323.8 & 12859.5 \\ \hline
\propername{Jamesbond} & \multicolumn{1}{l}{--} & \multicolumn{1}{l|}{--} & \mc{1}{\textbf{8550}} & 25.68 & 25 & 330 \\ \hline
\propername{Kangaroo} & \mc{1}{\textbf{5700}} & 7.9 & \mc{1}{5320} & 31 & 90 & 1990 \\ \hline
\propername{Krull} & \multicolumn{1}{l}{--} & \multicolumn{1}{l|}{--} & \mc{1}{\textbf{5124}} & 36.82 & 3089.2 & 5037 \\ \hline
\propername{Montezuma\_revenge} & 0 & 17.36 & \mc{1}{\textbf{80}} & 34.72 & 0 & 0 \\ \hline
\propername{Ms\_pacman} & \multicolumn{1}{l}{--} & \multicolumn{1}{l|}{--} & 14781 & 23.97 & 1708.5 & \textbf{22336} \\ \hline
\propername{Pong} & \textbf{21} & 16.67 & \textbf{21} & 34.92 & -20.7 & \textbf{21} \\ \hline
\propername{Pooyan} & 11225 & 7.97 & \multicolumn{1}{l}{--} & \multicolumn{1}{l|}{--} & 909.7 & \textbf{17763.4} \\ \hline
\propername{Qbert} & 3705 & 11.07 & 11680 & 34.61 & 132.8 & \textbf{17343.4} \\ \hline
\propername{Riverraid} & \multicolumn{1}{l}{--} & \multicolumn{1}{l|}{--} & \mc{1}{\textbf{5062}} & 36.53 & 2178.5 & 4449 \\ \hline
\propername{Seaquest} & \mc{1}{\textbf{14272}} & 24.91 & \mc{1}{6138} & 33.38 & 288 & 5132.4 \\ \hline
\propername{Space\_invaders} & \mc{1}{2877} & 21.37 & \mc{1}{\textbf{3974}} & 34.21 & 112.2 & 2718 \\ \hline
\propername{Star\_gunner} & \mc{1}{1540} & 18.89 & \mc{1}{\textbf{4660}} & 17.62 & 1345 & 1207.1 \\ \hline
\propername{Tennis} & \mc{1}{\textbf{23.8}} & 21.05 & \mc{1}{23.6} & 36.33 & -23.8 & 2.8 \\ \hline
\propername{Venture} & \mc{1}{775} & 23.41 & \mc{1}{\textbf{1080}} & 27.78 & 0 & 0 \\ \hline
\propername{Video\_pinball} & \multicolumn{1}{l}{--} & \multicolumn{1}{l|}{--} & 62074.6 & 43.13 & 55567.3 & \textbf{254748} \\ \hline
\propername{Zaxxon} & \multicolumn{1}{l}{--} & \multicolumn{1}{l|}{--} & 15680 & 31.01 & 0 & \textbf{22610} \\ \hline
...
\end{tabular}
 ...
 \caption{\small Performance that results from random policy and various  lookahead algorithms in 35 Atari games.
...
150,000 simulated frames, except for UCT limited to 500 rollouts, 300 frames deep instead. Average scores and CPU times per action selection shown.
Performance of UCT taken from \cite{bellemare:jair2013}.
Numbers  in bold show best performer in terms of average score. Numbers with light blue shade show that an algorithm outperformed \UCT.
--Domains containing (--) are still computing,  each run can take 24 hours of computation. All domains from \cite{bellemare:jair2013}  will be ready for the camera ready--. }
\label{performance}

\end{table*}
 We tested $\IW(1)$ and \BFS\ over $35$ games: those considered in
\cite{bellemare:jair2013}, abbreviated as BNVB \footnote{The full set
  of games is made of 55 games, 5 runs each. As each run takes around
  24 hours of CPU time, we luck the resources to submit the full table
  by the submission date, but the full table will be ready for the
  camera ready version.}. In Table~\ref{performance}, the
performance of $\IW(1)$ and \BFS\
...
is compared with that of \UCT\ and breadth-first search (\BRFS).
The discount factor used by all the algorithms is $\gamma=0.995$ and the average scores
reported for \BRFS\ and \UCT\ in  BNVB  are included for reference. 
Our experimental setup  follows the one in BNVB with one exception: a maximum budget of  $150,000$ simulated frames 
is applied to \textit{all the algorithms}, including  \UCT\ that is limited to  $500$ base policy rollouts of depth $300$.
% \footnote{In \UCT,  $500$ base policy rollouts
...
lookahead time, as most of the time in the lookahead search is spent
in the calls to the emulator for computing the next RAM state.  Also,
as in BNVB, all of the algorithms reuse the subtree from the previous
lookahead that is rooted in the selected child, deleting its siblings
and their descendants. More precisely, no calls to the emulator are
done for transitions that are cached in that subtree. As a result the
number of nodes in the lookahead tree may be larger actually than the
budget. In addition, in \IW, the states that are ``reused'' from the
previous searches are ignored in the computation of the novelty of new
states so that more states can escape pruning. Otherwise, \IW\ often
doesn't use the full budget. This is not needed in \BFS\ which does no
pruning.  $\IW(1)$ and \BFS\ have been limited the search to a depth of
$m=1500$ frames and up to $m=150,000$ frames per root branch. This is
to avoid the search for going too deep or being too committed to a
single root action. Similarly UCT defines a limit of $m=300$ frames
for each rollout. Note that UCT is more likely to have a performance
...
frames. The last difference inherited from BNVB between all algorithms
...
Table~\ref{performance} shows that $\IW(1)$ and \BFS\ both outperform
\BRFS, which rarely collects any reward in many domains, as the
depth of the \BRFS\ search tree results in a lookahead of $0.3$
seconds ($20$ frames or $4$ nodes deep). On the other hand, both
$\IW(1)$ and \BFS\ reach states that are up to $350$--$1500$ frames
deep ($70$--$260$ nodes or $6$--$22$ seconds), even if $\IW(1)$
doesn't always use all the simulation frames allocated due to its
agressive pruning. This behaviour can be observed in games such as
\Breakout, \CrazyClimber, \Kangaroo, and \Pooyan, where the average
CPU time for each lookahead is up to $10$ times faster than \BFS. Note
that computation time for \UCT\ and \BRFS\ is similar to \BFS, as the
most expensive computation is to generate a frame through the
simulator and all algorithms use always the full budget.


Interestingly, in terms of average scores out of $35$ games, simple $\IW(1)$ outperforms
\BFS\ and \UCT\ in $12$ and $17$ games respectively,
most often with lower average times per call. \BFS\ outscores  \IW\ and \UCT\ in
$11$ and $18$ of the games respectively \footnote{Note that both \IW\ and \BFS\ may improve, as 6 and 4 games  respectively are not reported in the table
  yet.}, and in overall, \IW\ and \UCT\ are the best performer in $12$ games, \BFS\ in $11$ games, and \BRFS in $1$ game. As mentioned in the
...
Likewise, $\IW(1)$ outperforms the best learning algorithm in
\cite{deep-mind-atari} in $7$ out of the $7$ games considered, and
\BFS\ does so in $6$ of the $7$ games.

We also note that in \Freeway, \Berzerk, \Bowling, \Montezuma,
\StarGunner, and \Venture, both $\IW(1)$ and \BFS\ attain a better
score than the baseline semi-random algorithm \emph{Perturb} in
\cite{bellemare:jair2013}, which outperforms both \UCT\ and the
reinforcement learning methods. \emph{Perturb} performance helps
understanding these domains. \emph{Perturb} selects a fixed action with probability
0.95 and otherwise acts uniformly randomly, and the best run out of 10
episodes is reported in BNVB. Note that all the other algorithms
report average score instead. The behaviour of \emph{Perturb} hinder
the nature of these domains: rewards are very deep, but tipically
repeating the same action may lead to some reward. 

Consider \Freeway, where a chicken has to run across a ten lane
highway filled with traffic. Every time it gets across, we
receive a point, i.e. a reward of 1. If the chicken is hit by a car,
the chicken is forced back. 12 out of 18 possible actions have an
effect: move up ( up-right, up-left, up-fire, up-right-fire,
up-left-fire, all have same effect as up ) or move down ( down-right,
down-left, down-fire, down-right-fire, down-left-fire, all have same
effect as down ), the remaining 6 actions are like no-ops. It's easy
to understand that \emph{Perturb} would achieve a high score if the
selected action is move up with 0.95 probability. In the following link
\url{http://www.youtube.com/playlist?list=PLXpQcXUQ_CwenUazUivhXyYvjuS6KQOI0}
we can observe videos of \IW\ and \UCT\ playing \Freeway. As reported
in Table~\ref{performance}, \UCT\ does not manage to take any chicken
across the highway, while \IW\ is the best performer out of all tested
algorithms. The main reason why \UCT\ performs so erratically is that
the rollouts do not manage to collect any reward, as there is a
$3^{-1}$ probability to choose any move up action, and given that the
depth of the closest reward is about 200 frames deep, the probability
of a rollout achieveing any reward is $3^{-200}$, which implies
choosing 200 move-up actions. On the other hand, \IW\ manages to find
rewards without exhausting the full budget. The main reason that
...
Another challenging game is \Montezuma. In this game rewards are very
sparse, deep, and most of the actions lead to loosing a life, which
only becomes effective after hundreds of frames, i.e. up-left may
enforce jumping and falling until we loose a life. All algorithms achieve 0 score, wheter RL-based or Planning-based. But, as
shown in Table~\ref{performance}, \BFS\ achieves an average score of
80, which is still a very low score, as the first possible reward
increases the score in 100. The best run by \BFS\ achieves a score of
400, pointing out that \BFS\ still is not able to consistently find rewards. One way to improve the performance of any algorithm in \Montezuma\ is to encode the lost of a life as a negative reward. Capturing the lost of lifes in the reward function is relevant to many games where not loosing a life is important in later stages of the game. Currently,
rewards are encoded directly as the change of score, which does not distinguish between the benefits of keeping lifes. This
beahaviour is also observed in other games like \Breakout\ and \SpaceInvaders, where \BFS\
is the best performer by far, although initially it looses all lifes but 1 and then plays extremely well. Videos on the link above illustrate
this behaviour.
...
\IW\ and the notion of width less clear. Another option is to change  \IW\ to comply with 
...
in their width. For this actually a simple change in \IW\ suffices: when generating a state 
...
in A* for preserving optimality when moving from consistent to inconsistent heuristics \cite{pearl:heuristics}. 
The alternative is to ``reopen'' such nodes. 
%The same change is actually in \BFS\ to ensure that, 
%if given enough time, \BFS\ will actually find the optimal paths.
...
experiments above does not implement this change, however, as the overhead involved in checking for duplicates 
in some test cases did not appear to pay off. More experimentation is probably needed.
...
games and to achieve  state-of-the-art performance. This is the result of a 
structured exploration of the state that manages to combine the scope of blind
search algorithms with the efficiency of heuristic search methods. 
%
\Omit{
We are currently addressing three
...
%
There are many issues worth studying, we just mention two of them.
One problem of all planning methods in Atari  games is that by using the 
RAM state of the Atari console they ``cheat'' a bit, as they use information that
is not available to the human player. In addition, a limitation of our
algorithms is that they do not get better with experience.  
In the future, we would like to explore whether  variations of these algorithms 
can be used to play  from the information in the  screen state as opposed to the RAM state, 
and the potential uses of the  ideas underlying these algorithms for learning.
