...
On the other, \UCT\ does better than $\IW(1)$ and \BFS\ in $15$ and $17$ games respectively.
...
with at least $48$~\footnote{One needs to move up the chicken up for at least $4$ seconds ($240$ frames) in order to get across the 
highway.} actions embedded that move the chicken up are required in order 
