...
to collect a reward. Since the probability for the roll-out to do an action that moves the chicken up 
is $1/3$, the likelihood of \UCT\ generating such a sequence of actions with the parameters chosen
by BNVB is rather low.
